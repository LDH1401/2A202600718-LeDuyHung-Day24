...
# Dùng đường dẫn tuyệt đối để enforcer hoạt động bất kể CWD khi chạy uvicorn.
...
def require_permission(resource: str, action: str):
    """Decorator kiểm tra RBAC permission qua Casbin. Raise 403 nếu thiếu quyền."""
    def decorator(func):
        @wraps(func)
        async def wrapper(*args, **kwargs):
            # current_user được FastAPI inject qua Depends(get_current_user)
